...
def index():
    ...
    return render_template('index.html', empresas=empresas, actividades=list(ACTIVIDADES_Y_SECTORES.keys()), sectores=sectores_unicos, actividades_dict=ACTIVIDADES_Y_SECTORES)
