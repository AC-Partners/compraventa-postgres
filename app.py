...
def index():
    ...
    return render_template('index.html', empresas=empresas, actividades=list(ACTIVIDADES_Y_SECTORES.keys()), sectores=sum(ACTIVIDADES_Y_SECTORES.values(), []), actividades_dict=ACTIVIDADES_Y_SECTORES)
...
def publicar():
    ...
    return render_template('vender_empresa.html', actividades=list(ACTIVIDADES_Y_SECTORES.keys()), sectores=sum(ACTIVIDADES_Y_SECTORES.values(), []), actividades_dict=ACTIVIDADES_Y_SECTORES)
...
def editar_anuncio(empresa_id):
    ...
    cur.close()
    conn.close()
    return render_template('editar.html', empresa=empresa, actividades=list(ACTIVIDADES_Y_SECTORES.keys()), sectores=sum(ACTIVIDADES_Y_SECTORES.values(), []), actividades_dict=ACTIVIDADES_Y_SECTORES)
