...
with open("actividades_sectores.json", "r", encoding="utf-8") as f_json:
    ACTIVIDADES_Y_SECTORES = json.load(f_json)
...
def get_all_sectores():
    return sorted(set(sec for lista in ACTIVIDADES_Y_SECTORES.values() for sec in lista))
...
def index():
    ...
    return render_template(
        ...
        sectores=get_all_sectores(),
        actividades_dict=ACTIVIDADES_Y_SECTORES,
        provincias=PROVINCIAS_ESPANOLAS
    )
