...
def get_all_sectores():
    sectores = set()
    for lista in ACTIVIDADES_Y_SECTORES.values():
        sectores.update(lista)
...
def index():
    ...
    return render_template('index.html', empresas=empresas, actividades=list(ACTIVIDADES_Y_SECTORES.keys()), sectores=get_all_sectores(), actividades_dict=ACTIVIDADES_Y_SECTORES, provincias=PROVINCIAS_ESPANOLAS)
